...
// const getCompanyName = (arr) => {
//     return arr.map((item) => item.company.name);
// }

// console.log(getCompanyName(arr));
...
// const calculateTotalLength = (users) => {
//     return users.reduce((totalLength, user) => {
//         const catchPhraseLength = user.company.catchPhrase.length;
//         return totalLength + catchPhraseLength;
//     }, 0);
// };



// console.log(calculateTotalLength(arr));